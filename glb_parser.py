...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, help="input directory of glb files", default="./model-glb")   #../../ccf-releases/v1.3/models/")
    parser.add_argument('--output_dir', type=str, help="output directory of off files", default="./" + folder_name)
